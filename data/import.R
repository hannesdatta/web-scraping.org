...
drive_download(as_id('1TU1q_jXhUXsVcyxCr9fYGD9mK6j3he5f'), path =  'file.xlsx', overwrite=T)

raw_coding <- data.table(readxl::read_xlsx('file.xlsx'))
raw_coding[, DOI:=gsub('\n', '', DOI)]
...
public_coding[, type:= '']
public_coding[scraped==0&api==0, type:= 'No programmatic extraction']
